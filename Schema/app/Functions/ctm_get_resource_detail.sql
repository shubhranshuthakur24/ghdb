CREATE OR REPLACE FUNCTION app.ctm_get_resource_detail(user_id integer, resource_id integer)
...
cg_user_id int := (select userid from app.care_giver cg where cg.care_giverid  = cgid );
