CREATE OR REPLACE FUNCTION app.cg_update_loved_one_info(user_id integer, first_name_val character varying, last_name_val character varying, zipcode_val character varying, user_gender_id integer, ethnicity_id integer[], dob_val date, relationship_id integer, disease_id jsonb, profile_picurl character, med_adv character varying, health_ins character varying, primarycarephysician character varying, hospital_of_choice character varying, contact_details text, known_allergy character varying, phramacy_information character varying, medication_list character varying, medic_aid character varying, long_term_ins character varying)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
begin
