CREATE OR REPLACE FUNCTION app.cg_update_user_info_new(user_id integer, zipcode_val character varying, user_gender_id integer, ethnicity_id integer[], dob date, contact_details character varying, profile_picurl character, firstname text, lastname text, mymantra text, timezone_id integer)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare 
