CREATE OR REPLACE FUNCTION app.nav_update_navigator_info(user_id integer, zipcode_val character varying, user_gender_id integer, ethnicity_id integer[], dob date, profile_picurl character, firstname text, lastname text, contact_detail character varying, mymantra text, education_val character varying, bio_val text, meetingurl character varying, expertise_id integer[], relationship_id integer, disease_id integer[])
 RETURNS void
 LANGUAGE plpgsql
AS $function$
begin
